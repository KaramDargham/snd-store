    ...
    <div className="mt-10 container flex justify-center">
      <div className="w-[90%]">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* First render all products in 3-column grid */}
          {products.map((product, index) => (
            <Link
              to={`/products/${product._id}`}
              className="bg-white shadow-md rounded-lg dark:bg-gray-800 dark:border-gray-700 flex justify-center items-center"
              key={index}
            >
                  ...
                  <img
                    ...
                    src={
                      product.imagesUrl && product.imagesUrl.length > 0
                        ? resolveImageUrl(product.imagesUrl[0])
                        : ""
                    }
                    alt={product.name}
                  />
          ...
          {/* Then add the "Shop More" card in a new row if needed */}
          <div className="col-span-1 md:col-span-3">
            <Link
              to={`/shop`}
              className="bg-white shadow-md rounded-lg w-full py-8 dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-evenly items-center"
            >
              <div className="w-full">
                <div className="flex justify-center">
